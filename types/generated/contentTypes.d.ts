...
export interface ApiLikeLike extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Likes von Nutzerinnen auf Threads';
    displayName: 'Like';
    pluralName: 'likes';
    singularName: 'like';
  };
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gemeldete Beitr\u00E4ge/Kommentare (Moderation)';
    displayName: 'Report';
    pluralName: 'reports';
    singularName: 'report';
  };
...
export interface ApiThreadThread extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Community-Themen (Beitr\u00E4ge), die Nutzerinnen erstellen';
    displayName: 'Thread';
    pluralName: 'threads';
    singularName: 'thread';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    base44_id: Schema.Attribute.String & Schema.Attribute.Unique;
